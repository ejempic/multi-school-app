...
import { tenants as initialTenants, Tenant } from "@/app/data/tenants";
...
import { AVAILABLE_FEATURES, PLAN_FEATURES } from "@/app/config";
        ...
        {tenants.filter(t => t.id !== 'admin').map((tenant) => (
          <Card key={tenant.id} className="overflow-hidden border-slate-200">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Button variant="ghost" size="icon" className="p-0" onClick={() => handleEditClick(tenant)}>
