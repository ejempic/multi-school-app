...
import { studentsByTenant, Student } from "@/app/data/mockData";
import { 
  Search, 
  Plus, 
  Mail, 
        ...
        <div className="grid grid-cols-3 gap-2 pt-4 border-t border-gray-50">
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="ghost" className="flex-col gap-1 hover:bg-blue-50 hover:text-blue-700">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="ghost" className="flex-col gap-1 hover:bg-amber-50 hover:text-amber-700">
            ...
            <DialogContent className="max-w-3xl">
              ...
              <div className="space-y-6 py-4">
                ...
                <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                  ...
                  <Button onClick={() => onNavigate?.("grades")}>Full Academic Audit</Button>
                </div>
              </div>
            </DialogContent>
          </Dialog>
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="ghost" className="flex-col gap-1 hover:bg-purple-50 hover:text-purple-700">
            ...
            {levels.map((level) => {
              ...
              return (
                <div key={level.id} className={`flex items-center justify-between p-2 rounded transition-colors cursor-pointer ${isSelected ? 'bg-blue-50 border border-blue-200' : 'hover:bg-gray-50'}`}>
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button variant="ghost" size="icon" className="p-0 opacity-0 hover:opacity-100 transition-opacity" onClick={(e) => e.stopPropagation()}>
                        ✎
                      </Button>
                    </DialogTrigger>
                    <DialogContent>
