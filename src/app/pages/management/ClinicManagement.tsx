            ...
            <Card>
                ...
                <Table>
                    ...
                    {filteredVisits.map((visit) => (
                        ...
                        <TableCell>
                            <Badge variant={
                            visit.status === "Active" ? "warning" :
                            visit.status === "Sent Home" ? "destructive" : "success"
                            }>
                            {visit.status}
                            </Badge>
                        </TableCell>
                        <TableCell>
                            <Button variant="ghost" size="icon" onClick={() => handleDeleteVisit(visit.id)} className="text-red-500 hover:text-red-600 hover:bg-red-50">
                                        ...
                                        <div className="flex flex-wrap gap-1">
                                            {record.medicalConditions.length > 0 ? (
                                                record.medicalConditions.map((cond, i) => (
                                                    <Badge key={i} variant="warning" className="text-[10px]"><AlertTriangle className="h-3 w-3"/>{cond}</Badge>
                                                ))
                                            ) : (
