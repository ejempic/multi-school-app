...
import { showSuccessToast, showInfoToast, showErrorToast } from "@/app/utils/toastNotification";
import { Card as ShadcnCard, CardContent as ShadcnCardContent, CardHeader as ShadcnCardHeader, CardTitle as ShadcnCardTitle } from "@/app/components/ui/card";
          ...
          <div className="space-y-1 overflow-hidden">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {member.access.hasAccount ? (
                <Badge variant={member.access.isLocked ? "warning" : "success"} className="text-[9px] uppercase">
          ...
          <div className="space-y-2 bg-slate-50/50 p-3 rounded-lg border border-slate-100 mt-2">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="outline" className="mt-1 w-full border-dashed text-slate-500 hover:text-blue-600 hover:border-blue-300 bg-transparent">
            ...
            <DialogContent className="sm:max-w-[400px]">
              ...
              {!member.access.hasAccount ? (
                <div className="space-y-4 py-4 px-1">
                  ...
                  <Button className="w-full" onClick={handleSendInviteLocal}>Generate System Access</Button>
                </div>
              ) : (
                <div className="space-y-5 py-4">
                  <div className="flex items-center justify-between p-4 bg-blue-50/50 border border-blue-100 rounded-xl">
                    ...
                    <Button 
                      variant={member.access.isLocked ? "success" : "destructive"}
                  ...
                  <div className="p-4 bg-gray-50 border border-gray-100 rounded-xl flex items-center justify-between">
                    ...
                    <Button variant="ghost">Reset PWD</Button>
                  </div>
                </div>
              )}
            </DialogContent>
