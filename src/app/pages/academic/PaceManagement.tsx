...
import { Download, Upload, Plus, Trash2, FileSpreadsheet, Edit2, Settings } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-4">
            ...
            <Button className="w-full" onClick={handleAddWorkbook}>
              <Plus className="h-4 w-4" /> Add Workbook
            </Button>
          </CardContent>
        </Card>
                  ...
                  {workbooks.map((seq, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell className="flex items-center gap-1">
                        ...
                        <Button variant="ghost" size="icon" className="text-red-500 hover:text-red-700 hover:bg-red-50" onClick={() => handleRemoveWorkbook(index)}>
